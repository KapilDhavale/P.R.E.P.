...
import './subjectpagedsa.css';

import { useNavigate } from 'react-router-dom';
import Navbar from '../../../../navbarsem4';
import axios from 'axios';

const SubjectPageDSA = () => {
  ...
  const handleSubjectClick = (item) => {
    if (item === 'DSA') {
      ...
      navigate('/branch/ecs/sem4/subject/subjectpagedsa');
    }
    if (item === 'ED') {
      // Navigate to the subject page programmatically
  ...
  return (
    <div className="bg-container">
      ...
      <div className="subject-name">
        <h2>Discreete Structure & Automata Theory</h2>
      </div>
